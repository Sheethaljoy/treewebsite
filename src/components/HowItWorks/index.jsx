...
const HowItWorks = () => {
  ...
  className="
    ...
    font-[300]
    leading-[20px] sm:leading-[22px] md:leading-[24px] lg:leading-[25.46px] xl:leading-[28px]
    text-left
...
>
  Thanks for your interest in working with us. Please complete the details below and we'll get back to you within one business day.
        ...
        {/* Contact Form */}
        <form className="w-full max-w-2xl text-left ml-0" onSubmit={handleSubmit}>
          <p className="mb-9 text-left text-[20px] font-[500] font-futuraLight leading-[25.26px] text-zinc-500">
            Required
          </p>

          <div className="mb-6">
            <label className="block mb-2 font-futuraLight font-[500] text-[20px] leading-[25.26px] text-left">
              Name
              <span className="font-futuraLight text-[20px] font-[500] bg-gradient-to-br from-[#6675F7] to-[#57007B] bg-clip-text text-transparent">
                *
              </span>
            </label>
            <input
          ...
          <div className="mb-6">
            <label className="font-futuraLight text-[20px] leading-[25.26px] text-left">
              Phone No
              <span className="font-futuraLight text-[20px] font-medium bg-gradient-to-br from-[#6675F7] to-[#57007B] bg-clip-text text-transparent">
                *
              </span>
            </label>
            <input
          ...
          <button type="submit" className="bg-gradient-to-r from-purple-500 to-indigo-500 text-white py-[14px] px-[25px] rounded-[10px] text-center text-[20px] font-[700] leading-[14px] font-futuraLight">
            SUBMIT
          </button>
        </form>
      </main>
